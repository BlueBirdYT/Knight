...
async def status_task():
    while True:
        ...
        await client.change_presence(game=discord.Game(name='created my DP♡#1471'))
...
async def on_reaction_add(reaction, user):
     ...
     if reaction.emoji == '🎦':
           ...
           embed.set_image(url = 'https://image.ibb.co/caM2BK/help.gif')    
           embed.add_field(name = '*invite', value ='use it like n!invite',inline = False)
           embed.add_field(name = '*say', value ='use it like n!say (msg)',inline = False)
           embed.add_field(name = '*remind', value ='use it like n!remind (time in seconds)',inline = False)
           embed.add_field(name = '*mention (admin is required)', value ='use it like n!mention (rolename) (msg if you want)',inline = False)
           embed.add_field(name = '*ownerinfo', value ='use it like n!ownerinfo',inline = False)
           embed.add_field(name = '*poll', value =' type n!poll and it will send a message of how to use poll',inline = False)
           embed.add_field(name = '*server', value ='use it like n!server to get link to the support server',inline = False)
           embed.add_field(name = '*play', value ='use it like n!play (url or name)',inline = False)
           embed.add_field(name = '*stop', value ='use it like n!stop to stop the music',inline = False)
           embed.add_field(name = '*queue', value ='use it like n!queue to see the queue',inline = False)
           embed.add_field(name = '*np', value ='use it like n!np to see the current song',inline = False)
           embed.add_field(name = '*volume', value ='use it like n!volume or n!volume (sound amount)',inline = False)
           embed.add_field(name = '*pause', value ='use it like n!pause',inline = False)
           embed.add_field(name = '*resume', value ='use it like n!resume',inline = False)
           embed.add_field(name = '*skip', value ='use it like n!skip to skip the current song',inline = False)
           await client.send_message(user,embed=embed)     
...
async def help(ctx):
    if ctx.message.author.bot:
      ...
      embed.set_image(url = 'https://image.ibb.co/caM2BK/help.gif')
      embed.add_field(name = 'Having doubts? Join our server and clear your doubts. Server link:',value ='https://discord.gg/ZyTwScu',inline = False)
