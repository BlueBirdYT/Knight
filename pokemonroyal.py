...
async def status_task():
    while True:
        await client.change_presence(game=discord.Game(name='for *help, *help2 ,*help3', type=2))
...
async def on_reaction_add(reaction, user):
     if reaction.emoji == '🇬':           
            ...
            embed.add_field(name = '*setw (admin is required)',value ='use it like tw',inline = False)
            embed.add_field(name = '*setuplog (admin is required)',value ='use it like n!setuplog',inline = False)
            embed.add_field(name = '*getuser (mod or admin is required)',value ='use it like n!getuser (rolename)',inline = False)
            embed.add_field(name = '*userinfo (mod or admin is required)',value ='use it like n!userinfo @user',inline = False)
            embed.add_field(name = '*roleinfo (mod or admin is required)',value ='use it like n!roleinfo (rolename)',inline = False)
            embed.add_field(name = '*rolecolor (mod or admin is required)',value ='use it like n!rolecolor (rolename) (hex code)',inline = False)
            embed.add_field(name = '*role (mod or admin is required)',value ='use it like n!role @user (rolename)',inline = False)
            embed.add_field(name = '*warn (mod or admin is required)', value ='use it like n!warn @user (reason)',inline = False)
            embed.add_field(name = '*virus', value ='use it like n!virus @user',inline = False)
            embed.add_field(name = '*invites', value ='use it like !invites or !invites @user',inline = False)
            embed.add_field(name = '*tweet', value ='use it like n!tweet (name) (msg)',inline = False)
            embed.add_field(name = '*announce (admin is required)', value ='use it like n!announce #channel (msg)',inline = False)
            embed.add_field(name = '*addchannel (admin is required)', value ='use it like n!addchannel (name)',inline = False)
            embed.add_field(name = '*delchannel (admin is required', value ='use it like n!delchannel or n!delchannel #channelname',inline = False)
            embed.add_field(name = '*mute (mod or admin is required and must have log setup or automute will not work)', value ='use it like n!mute @user (mute time)',inline = False)
            embed.add_field(name = '*meme', value ='use it like n!meme',inline = False)
            embed.add_field(name = '*avatar', value ='use it like n!avatar or n!avatar @user',inline = False)
            embed.add_field(name = '*flipcoin', value ='use it like n!flipcoin',inline = False)
            embed.add_field(name = '*unmute (mod or admin is required)', value ='use it like n!unmute @user',inline = False)
     ...
     if reaction.emoji == '🇲':
           ...
           embed.set_image(url = 'https://image.ibb.co/caM2BK/help.gif')    
           embed.add_field(name = 'n!addrole (admin is required)', value ='use it like n!addrole (name)',inline = False)
           embed.add_field(name = 'n!delrole (admin is required)', value ='use iy like n!delrole (rolename)',inline = False)
           embed.add_field(name = 'n!setnick (admin is required)', value ='use it like n!setnick @user (name)',inline = False)
           embed.add_field(name = 'n!purge (mod or admin is required)', value ='use it like n!purge (number)',inline = False)
           embed.add_field(name = 'n!ban (mod or admin is required)', value ='use it like n!ban @user',inline = False)
           embed.add_field(name = 'n!unban (mod or admin is required)', value ='use it like n!unban @user',inline = False)
           embed.add_field(name = 'n!bans (admin is required)', value ='use it like n!bans',inline = False)
           embed.add_field(name = 'n!serverinfo', value ='use it like n!serverinfo',inline = False)
           embed.add_field(name = 'n!membercount', value ='use it like n!membercount',inline = False)
           embed.add_field(name = 'n!happybday', value ='use it like n!happybday to send a happy birthday message to someone',inline = False)            
           embed.add_field(name = 'n!slap', value ='use it like n!slap @user',inline = False)
           ...
           embed.add_field(name = 'n!google', value ='use it like n!google (name)',inline = False)
           embed.add_field(name = 'n!rps', value ='use it like n!rps (rock,paper,scissors) choose one',inline = False)
           embed.add_field(name = 'n!kick (mod or admin is required', value ='use it like n!kick @user',inline = False)
           embed.add_field(name = 'n!kiss', value ='use it like n!kiss @user',inline = False)
           embed.add_field(name = 'n!hug', value ='use it like n!hug @user',inline = False)
           embed.add_field(name = 'n!joke', value ='use it like n!joke',inline = False)
           embed.add_field(name = 'n!rolldice', value ='use it like n!rolldice (1 -6) choose one',inline = False)
           await client.send_message(user,embed=embed)
     if reaction.emoji == '🎦':
           r, g, b = tuple(int(x * 255) for x in colorsys.hsv_to_rgb(random.random(), 1, 1))
           embed = discord.Embed(color = discord.Color((r << 16) + (g << 8) + b))
           ...
           embed.set_image(url = 'https://image.ibb.co/caM2BK/help.gif')    
           embed.add_field(name = 'n!invite', value ='use it like n!invite',inline = False)
           embed.add_field(name = 'n!say', value ='use it like n!say (msg)',inline = False)
           embed.add_field(name = 'n!remind', value ='use it like n!remind (time in seconds)',inline = False)
           embed.add_field(name = 'n!mention (admin is required)', value ='use it like n!mention (rolename) (msg if you want)',inline = False)
           ...
           embed.add_field(name = 'n!server', value ='use it like n!server to get link to the support server',inline = False)
           embed.add_field(name = 'n!play', value ='use it like n!play (url or name)',inline = False)
           embed.add_field(name = 'n!stop', value ='use it like n!stop to stop the music',inline = False)
           embed.add_field(name = 'n!queue', value ='use it like n!queue to see the queue',inline = False)
           embed.add_field(name = 'n!np', value ='use it like n!np to see the current song',inline = False)
           embed.add_field(name = 'n!volume', value ='use it like n!volume or n!volume (sound amount)',inline = False)
           embed.add_field(name = 'n!pause', value ='use it like n!pause',inline = False)
           embed.add_field(name = 'n!resume', value ='use it like n!resume',inline = False)
           embed.add_field(name = 'n!skip', value ='use it like n!skip to skip the current song',inline = False)
           embed.add_field(name = 'n!movie', value ='use it like n!movie (movie name)',inline = False)
           await client.send_message(user,embed=embed)     
...
async def invite():
    r, g, b = tuple(int(x * 255) for x in colorsys.hsv_to_rgb(random.random(), 1, 1))
    embed = discord.Embed(color = discord.Color((r << 16) + (g << 8) + b))
    embed.add_field(name = 'Link to invite me', value='https://discordapp.com/api/oauth2/authorize?client_id=545979318875062290&permissions=8&scope=bot')
    await client.say(embed=embed)
    await client.delete_message(ctx.message)
...
async def help3(ctx):
    ...
    embed.add_field(name = 'botinfo', value ='check the bots info',inline = False)
